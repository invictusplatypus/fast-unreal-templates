...
namespace DiversionUtils
{
	...
	/**
	 * Returns the operating system family name, compatible with the Diversion analytics scheme.
	 * Values: "Windows", "MacOSX", "Linux", or "Other".
	 */
	COMMON_API FString GetOperatingSystemName();
}
